...
\vspace{10pt}\noindent\textbf{\Large\color{primaryColor} #1}\par\vspace{2pt}\hrule\vspace{5pt}
}
...
\newenvironment{onecolentry}{
    \par\noindent\hspace{0.2cm}\begin{minipage}{\dimexpr\linewidth-0.4cm\relax}
}{
    \end{minipage}\par
...
\newenvironment{twocolentry}[2][]{
    \def\secondColumn{#2}
    \par\vspace{0.1cm}\noindent
    \begin{minipage}[t]{\dimexpr\linewidth-4.5cm-0.4cm\relax}
}{
    \end{minipage}%
    \hfill
...
\newenvironment{threecolentry}[3][]{
    ...
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{\dimexpr\linewidth-1.5cm-4.5cm-0.4cm\relax}
}{
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{4.5cm}
...
\newcommand{\href}[2]{#2}
\newcommand{\hrefWithoutArrow}[2]{#2}
\newcommand{\faMapMarker}{Location: }
\newcommand{\faEnvelope}{Email: }
\newcommand{\faPhone}{Phone: }
\newcommand{\faLink}{Web: }
\newcommand{\faLinkedinIn}{LinkedIn: }
